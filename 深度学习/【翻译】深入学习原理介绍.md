...
> Consider the set of computations allowed in each node and possible
> graph structures and this defines a family of functions. Input nodes
> have no children. Output nodes have no parents.
